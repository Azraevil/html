...
(function () {
    ...
    if (!("undefined" === typeof window.Element || "classList" in document.documentElement)) {
        ...
        a.prototype = {
            ...
            toString: function () { return f.call(this, " ") }, toggle: function (a) {
                this.contains(a) ? this.remove(a) : this.add(a);
                return this.contains(a)
            }
        };
        window.DOMTokenList = a;
        b(HTMLElement.prototype, "classList", function () { return new a(this) })
    }
})();
(function () {
    ...
    window.requestAnimationFrame || (window.requestAnimationFrame = function (b, c) {
        var f = (new Date).getTime(), h = Math.max(0, 16 - (f - a)), g = window.setTimeout(function () { b(f + h) }, h);
        a = f + h;
        return g
    });
...
KeyboardInputManager.prototype.listen = function () {
    ...
    e.addEventListener(this.eventTouchmove, function (a) { a.preventDefault() });
...
HTMLActuator.prototype.actuate = function (a, b) {
    ...
    window.requestAnimationFrame(function () {
        ...
        a.cells.forEach(function (a) { a.forEach(function (a) { a && c.addTile(a) }) });
...
HTMLActuator.prototype.addTile = function (a) {
    var b = this, c = document.createElement("div"), d = document.createElement("div"), e = this.positionClass(a.previousPosition || { x: a.x, y: a.y }), f = ["tile", "tile-" + a.value, e];
    ...
    a.previousPosition ? window.requestAnimationFrame(function () {
        ...
        b.applyClasses(c, f)
    }) : a.mergedFrom ? (f.push("tile-merged"), this.applyClasses(c, f), a.mergedFrom.forEach(function (a) { b.addTile(a) })) :
       (f.push("tile-new"), this.applyClasses(c, f));
    c.appendChild(d);
    this.tileContainer.appendChild(c)
};
HTMLActuator.prototype.applyClasses = function (a, b) { a.setAttribute("class", b.join(" ")) };
HTMLActuator.prototype.normalizePosition = function (a) { return { x: a.x + 1, y: a.y + 1 } };
...
HTMLActuator.prototype.updateBestScore = function (a) { this.bestContainer.textContent = a };
...
Grid.prototype.availableCells = function () {
    var a = [];
    this.eachCell(function (b, c, d) { d || a.push({ x: b, y: c }) });
    return a
};
Grid.prototype.eachCell = function (a) {
    ...
    b++) for (var c = 0;
    c < this.size;
    c++) a(b, c, this.cells[b][c])
};
Grid.prototype.cellsAvailable = function () { return !!this.availableCells().length };
Grid.prototype.cellAvailable = function (a) { return !this.cellOccupied(a) };
Grid.prototype.cellOccupied = function (a) { return !!this.cellContent(a) };

Grid.prototype.cellContent = function (a) { return this.withinBounds(a) ? this.cells[a.x][a.y] : null };
Grid.prototype.insertTile = function (a) { this.cells[a.x][a.y] = a };
Grid.prototype.removeTile = function (a) { this.cells[a.x][a.y] = null };
Grid.prototype.withinBounds = function (a) { return 0 <= a.x && a.x < this.size && 0 <= a.y && a.y < this.size };
...
Grid.prototype.serialize = function () {
    for (var a = [], b = 0;
     ...
     b++) for (var c = a[b] = [], d = 0;
     d < this.size;
     d++) c.push(this.cells[b][d] ? this.cells[b][d].serialize() : null);
...
window.fakeStorage = { _data: {}, setItem: function (a, b) { return this._data[a] = String(b) }, getItem: function (a) { return this._data.hasOwnProperty(a) ? this._data[a] : void 0 }, removeItem: function (a) { return delete this._data[a] }, clear: function () { return this._data = {} } };
...
LocalStorageManager.prototype.localStorageSupported = function () {
    ...
    try { return a.setItem("test", "1"), a.removeItem("test"), !0 } catch (b) { return !1 }
};
LocalStorageManager.prototype.getBestScore = function () { return this.storage.getItem(this.bestScoreKey) || 0 };
LocalStorageManager.prototype.setBestScore = function (a) { this.storage.setItem(this.bestScoreKey, a) };
LocalStorageManager.prototype.getGameState = function () {
    var a = this.storage.getItem(this.gameStateKey);
    return a ? JSON.parse(a) : null
};

LocalStorageManager.prototype.setGameState = function (a) { this.storage.setItem(this.gameStateKey, JSON.stringify(a)) };
...
GameManager.prototype.isGameTerminated = function () { return this.over || this.won && !this.keepPlaying ? !0 : !1 };
...
GameManager.prototype.addRandomTile = function () {
    if (this.grid.cellsAvailable()) {
        var a = 0.9 > Math.random() ? 2 : 4, a = new Tile(this.grid.randomAvailableCell(), a);
...
GameManager.prototype.prepareTiles = function () { this.grid.eachCell(function (a, b, c) { c && (c.mergedFrom = null, c.savePosition()) }) };
...
GameManager.prototype.getVector = function (a) { return { 0: { x: 0, y: -1 }, 1: { x: 1, y: 0 }, 2: { x: 0, y: 1 }, 3: { x: -1, y: 0 } }[a] };
...
GameManager.prototype.tileMatchesAvailable = function () {
    for (var a, b = 0; b < this.size; b++) for (var c = 0; c < this.size; c++)
